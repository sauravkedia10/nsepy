...
import sys
PRICE_HISTORY_CSV = 'http://archives.nseindia.com/content/indices/histdata/%s%s-%s.csv'
PE_HISTORY_CSV = 'http://archives.nseindia.com/content/indices/histdata/%sall%s-TO-%s.csv'
PRICE_HISTORY = 'http://archives.nseindia.com/products/dynaContent/equities/indices/historicalindices.jsp?indexType=%s&fromDate=%s&toDate=%s'
PE_HISTORY = 'http://archives.nseindia.com/products/dynaContent/equities/indices/historical_pepb.jsp?indexName=%s&fromDate=%s&toDate=%s&yield1=undefined&yield2=undefined&yield3=undefined&yield4=all'
